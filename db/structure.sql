...
--
-- Name: dependences; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE dependences (
    ...
    provider_id bigint,
    dependant_type character varying,
    dependant_id bigint,
...
--
-- Name: dependences_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE dependences_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: dependences_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE dependences_id_seq OWNED BY dependences.id;
...
--
-- Name: math_maps; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE math_maps (
    id bigint NOT NULL,
    name character varying,
...
--
-- Name: math_maps_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE math_maps_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: math_maps_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE math_maps_id_seq OWNED BY math_maps.id;


--
-- Name: math_objects; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: math_objects_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE math_objects_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: math_objects_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE math_objects_id_seq OWNED BY math_objects.id;
...
--
-- Name: dependences id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY dependences ALTER COLUMN id SET DEFAULT nextval('dependences_id_seq'::regclass);
...
--
-- Name: math_maps id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY math_maps ALTER COLUMN id SET DEFAULT nextval('math_maps_id_seq'::regclass);


--
-- Name: math_objects id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY math_objects ALTER COLUMN id SET DEFAULT nextval('math_objects_id_seq'::regclass);
...
--
-- Name: dependences dependences_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: math_maps math_maps_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY math_maps
    ADD CONSTRAINT math_maps_pkey PRIMARY KEY (id);


--
-- Name: math_objects math_objects_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY math_objects
    ADD CONSTRAINT math_objects_pkey PRIMARY KEY (id);
...
--
-- Name: index_dependences_on_dependant_type_and_dependant_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_dependences_on_dependant_type_and_dependant_id ON dependences USING btree (dependant_type, dependant_id);


--
-- Name: index_dependences_on_provider_type_and_provider_id; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX index_dependences_on_provider_type_and_provider_id ON dependences USING btree (provider_type, provider_id);
